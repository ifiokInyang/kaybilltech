	...
	return (
		<div className="flex flex-wrap ss:px-4 md:px-8 ss:w-[355px] sm:w-full justify-between">
			<div className="flex-1 mt-[72px] ss:order-2 md:order-1">
				...
				<h2 className="py-4 font-semibold">Exceptional user friendly design</h2>

				<p className="font-light text-[#39404F]">
				...
				<h2 className="pb-4 pt-8 font-semibold">
					Increase data driven strategies and optimization
				</h2>

				<p className="ss:tracking-tight md:tracking-wider font-light text-[#39404F]">
